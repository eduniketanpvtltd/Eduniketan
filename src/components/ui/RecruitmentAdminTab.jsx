          ...
          <div className="lg:col-span-6 xl:col-span-5">
            <Card className="p-6 border-slate-200 space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  <label className="block text-xs font-semibold text-slate-700 mb-1">Confirmation Message (Optional)</label>
                  <textarea
                    value={activeDraft.confirmationMessage || ''}
                    onChange={(e) => setActiveDraft({ ...activeDraft, confirmationMessage: e.target.value })}
                    placeholder="e.g. Thank you for your application! We will review your details and get back to you soon."
                    className="w-full px-3 py-2 text-xs border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none resize-none bg-white"
                    rows={2}
                  />
                  <p className="text-[10px] text-slate-400 mt-1">This message will be shown to students after successful submission.</p>
                </div>
